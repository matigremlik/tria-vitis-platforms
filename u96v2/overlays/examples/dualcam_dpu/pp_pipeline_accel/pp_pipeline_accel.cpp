...
#pragma HLS INTERFACE s_axilite port=return    bundle=control
    ...
    // Force no unrolling (keeps area down)
...
#pragma HLS LOOP_TRIPCOUNT min=224 max=224
#pragma HLS PIPELINE II=8   // <<< key change: relax II so it doesn't explode area
#pragma HLS UNROLL factor=1 // <<< ensure not unrolled
